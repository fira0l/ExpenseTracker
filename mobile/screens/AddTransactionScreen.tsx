    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={styles.content}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            setAmount('285.50')
            setDescription('Scanned Grocery Store')
            Alert.alert('Receipt Scanned! 📷', 'Extracted Merchant: Grocery Store\nExtracted Amount: $285.50')
          }}
        >
          <Text style={{ color: '#D9FF5B', fontWeight: '700', fontSize: 14 }}>📷 Scan Paper Receipt (AI Vision)</Text>
        </TouchableOpacity>
        ...
        <View style={{ height: 60, marginBottom: 20 }}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ alignItems: 'center' }}>
            ...
            <TouchableOpacity
              ...
              style={[styles.catChip, selectedCat === cat.id && { borderColor: '#D9FF5B', backgroundColor: 'rgba(217, 255, 91, 0.12)' }]}
            >
